...
export default function LoadingScreen({ intervalTimingMS }: { intervalTimingMS: number }) {
  ...
  return (
    <main className="w-screen h-screen bg-kaar-950 flex flex-col items-center text-center pt-48">
      <h1 className="text-9xl font-extralight text-kaar-100">“Why you’re waiting?”</h1>
      <p className="mt-[71px] text-kaar-100 text-4xl font-extralight">{loadingTextArray[loadingTextIndex]}</p>
      <div
      ...
      {loadingProgress >= 100 && <div className="animate-spin mt-24 origin-center">
        <LoadingCircle />
      </div>}
    </main>
  )
